...
- Rotate any local or shared secrets that were ever exposed outside Railway/Vercel secret storage.
...
- Confirm M-Pesa callback URL points to the current Railway backend.
