...
export const DHA_OPERATIONS = {
  ...
  EXECUTE_ECLAIMS: 'EXECUTE_ECLAIMS',
  SUBMIT_REFERRAL: 'SUBMIT_REFERRAL',
  REGISTER_PATIENT: 'REGISTER_PATIENT',
  SCAN_WORKFLOW_ATTACHMENT: 'SCAN_WORKFLOW_ATTACHMENT',
  UPLOAD_WORKFLOW_ATTACHMENT: 'UPLOAD_WORKFLOW_ATTACHMENT',
  SUBMIT_MULTIPART_WORKFLOW: 'SUBMIT_MULTIPART_WORKFLOW',
  PUBLISH_SHR_BUNDLE: 'PUBLISH_SHR_BUNDLE',
} as const;
