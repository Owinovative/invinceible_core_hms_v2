  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-cyan-500/10 text-cyan-600 dark:text-cyan-300">
        ...
        <div className="min-w-0">
          ...
          <div className="mt-2 flex items-center gap-1 text-xs text-cyan-600 dark:text-cyan-300">
            Open module
