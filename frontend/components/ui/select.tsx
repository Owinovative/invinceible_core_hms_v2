...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      className={cn(
        "z-10 flex cursor-default items-center justify-center bg-[hsl(var(--popover))] py-1 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    >
